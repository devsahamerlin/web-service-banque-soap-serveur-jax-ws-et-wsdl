 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://service.saha.merlin.com/", wsdlLocation = "http://0.0.0.0:4455/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://service.saha.merlin.com/", "BanqueWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://0.0.0.0:4455/?wsdl");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://service.saha.merlin.com/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.saha.merlin.com/", "BanqueServicePort"), BanqueService.class, features);
    }
